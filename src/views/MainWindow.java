...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void jButtonTestConActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTestConActionPerformed
        ...
        server = new Server(name, address, username);
        char[] password = jPasswordField.getPassword();
        connected = server.testConnection(password);
        ...
        int message_type = (connected) ? JOptionPane.INFORMATION_MESSAGE : JOptionPane.ERROR_MESSAGE;
        String message = (connected) ? "Connection Successful" : "Connection Unsuccessful";
